...
use corrective_erlpboost::CorrectiveErlpBoost;
use decision_tree::*;

/// Tests for `CorrectiveErlpBoost`.
#[cfg(test)]
pub mod tests {
    use super::*;
    // #[test]
    ...
    fn logging_test() {
        ...
        let booster = CorrectiveErlpBoost::init(&sample)
            .tolerance(TOLERANCE)
            .update_rule(FwUpdateRule::LineSearch)
            .nu(nu);
